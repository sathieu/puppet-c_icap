...
describe 'c_icap' do
  ...
  describe 'Test noops mode' do
    ...
    it { should contain_package('c-icap').with_noop('true') }
    it { should contain_service('c-icap').with_noop('true') }
    it { should contain_file('c-icap.conf').with_noop('true') }
    it { should contain_monitor__process('c_icap_process').with_noop('true') }
    it { should contain_monitor__process('c_icap_process').with_noop('true') }
    it { should contain_monitor__port('c_icap_tcp_42').with_noop('true') }
    it { should contain_firewall('c_icap_tcp_42').with_noop('true') }
  end
